...
#runs 1000 rounds of the game and prints the stats at the end to see how well the AI did (wins, losses, ties, money made)
#first the dealer shuffles the deck and prints out the shuffled deck at the beginning
#at the beginning of each round, it will display the round number and the initial hands of both the dealer and the player
